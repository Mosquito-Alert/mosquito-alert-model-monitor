...
📖 **For detailed system architecture and data flow, see [ARCHITECTURE.qmd](docs/ARCHITECTURE.html)**
...
- **ARCHITECTURE.qmd**: Complete system architecture with Mermaid diagrams showing data flow
